...
```bash
curl -X DELETE \
    "http://localhost/oauth/tokens/aut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://localhost/oauth/personal-access-tokens/accusamus" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"username":"maxime","email":"voluptatem","password":"labore","r_password":"molestias"}'
...
<input type="text" name="username" data-endpoint="POSTapi-signup" data-component="body"  hidden>
<br>
</p>
<p>
...
<input type="text" name="password" data-endpoint="POSTapi-signup" data-component="body"  hidden>
<br>
</p>
<p>
<b><code>r_password</code></b>&nbsp;&nbsp;<small>string</small>     <i>optional</i> &nbsp;
<input type="text" name="r_password" data-endpoint="POSTapi-signup" data-component="body"  hidden>
<br>
Repeat the password</p>
...
<p>
<b><code>password</code></b>&nbsp;&nbsp;<small>string</small>     <i>optional</i> &nbsp;
<input type="text" name="password" data-endpoint="POSTapi-login" data-component="body"  hidden>
<br>
</p>
...
```json
{
    ...
    "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation\\Exceptions\\Handler.php",
    "line": 373,
    "trace": [
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation\\Exceptions\\Handler.php",
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\nunomaduro\\collision\\src\\Adapters\\Laravel\\ExceptionHandler.php",
            "line": 54,
            "function": "render",
            "class": "Illuminate\\Foundation\\Exceptions\\Handler",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Routing\\Pipeline.php",
            "line": 51,
            "function": "render",
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Pipeline\\Pipeline.php",
            "line": 130,
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Routing\\Middleware\\SubstituteBindings.php",
            "line": 50,
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Routing\\Middleware\\ThrottleRequests.php",
            "line": 127,
            "function": "Illuminate\\Pipeline\\{closure}",
            "class": "Illuminate\\Pipeline\\Pipeline",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Routing\\Router.php",
            "line": 695,
            "function": "then",
            "class": "Illuminate\\Pipeline\\Pipeline",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation\\Http\\Kernel.php",
            "line": 166,
            "function": "dispatch",
            "class": "Illuminate\\Routing\\Router",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation\\Http\\Middleware\\TransformsRequest.php",
            "line": 21,
            "function": "Illuminate\\Pipeline\\{closure}",
            "class": "Illuminate\\Pipeline\\Pipeline",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation\\Http\\Middleware\\ValidatePostSize.php",
            "line": 27,
            "function": "Illuminate\\Pipeline\\{closure}",
            "class": "Illuminate\\Pipeline\\Pipeline",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation\\Http\\Middleware\\PreventRequestsDuringMaintenance.php",
            "line": 86,
            "function": "Illuminate\\Pipeline\\{closure}",
            "class": "Illuminate\\Pipeline\\Pipeline",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\fruitcake\\laravel-cors\\src\\HandleCors.php",
            "line": 57,
            "function": "Illuminate\\Pipeline\\{closure}",
            "class": "Illuminate\\Pipeline\\Pipeline",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\fideloper\\proxy\\src\\TrustProxies.php",
            "line": 57,
            "function": "Illuminate\\Pipeline\\{closure}",
            "class": "Illuminate\\Pipeline\\Pipeline",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\knuckleswtf\\scribe\\src\\Extracting\\Strategies\\Responses\\ResponseCalls.php",
            "line": 324,
            "function": "handle",
            "class": "Illuminate\\Foundation\\Http\\Kernel",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\knuckleswtf\\scribe\\src\\Extracting\\Generator.php",
            "line": 236,
            "function": "__invoke",
            "class": "Knuckles\\Scribe\\Extracting\\Strategies\\Responses\\ResponseCalls",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\knuckleswtf\\scribe\\src\\Commands\\GenerateDocumentation.php",
            "line": 119,
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Container\\BoundMethod.php",
            "line": 36,
            "function": "handle",
            "class": "Knuckles\\Scribe\\Commands\\GenerateDocumentation",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Container\\Util.php",
            "line": 40,
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Container\\Container.php",
            "line": 610,
            "function": "call",
            "class": "Illuminate\\Container\\BoundMethod",
            "type": "::"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Console\\Command.php",
            "line": 136,
            "function": "call",
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\symfony\\console\\Command\\Command.php",
            "line": 256,
            "function": "execute",
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\symfony\\console\\Application.php",
            "line": 971,
            "function": "run",
            "class": "Illuminate\\Console\\Command",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Console\\Application.php",
            "line": 92,
            "function": "run",
            "class": "Symfony\\Component\\Console\\Application",
            "type": "->"
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation\\Console\\Kernel.php",
            "line": 129,
            "function": "run",
        ...
        {
            "file": "D:\\Tools\\Lab\\lab-laravel\\artisan",
            "line": 37,
            "function": "handle",
...
```
<div id="execution-results-GETapi-games--id-" hidden>
    <blockquote>Received response<span id="execution-response-status-GETapi-games--id-"></span>:</blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-games--id-"></code></pre>
</div>
<div id="execution-error-GETapi-games--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-games--id-"></code></pre>
</div>
<form id="form-GETapi-games--id-" data-method="GET" data-path="api/games/{id}" data-authed="0" data-hasfiles="0" data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}' onsubmit="event.preventDefault(); executeTryOut('GETapi-games--id-', this);">
<h3>
    Request&nbsp;&nbsp;&nbsp;
        <button type="button" style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-tryout-GETapi-games--id-" onclick="tryItOut('GETapi-games--id-');">Try it out ⚡</button>
    <button type="button" style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-canceltryout-GETapi-games--id-" onclick="cancelTryOut('GETapi-games--id-');" hidden>Cancel</button>&nbsp;&nbsp;
    <button type="submit" style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-executetryout-GETapi-games--id-" hidden>Send Request 💥</button>
    </h3>
<p>
<small class="badge badge-green">GET</small>
...
<input type="text" name="id" data-endpoint="GETapi-games--id-" data-component="url" required  hidden>
<br>
</p>
</form>
...
```bash
curl -X GET \
    -G "http://localhost/api/games/nisi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```
<div id="execution-results-GETapi-games--game-" hidden>
    <blockquote>Received response<span id="execution-response-status-GETapi-games--game-"></span>:</blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-games--game-"></code></pre>
</div>
<div id="execution-error-GETapi-games--game-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-games--game-"></code></pre>
</div>
<form id="form-GETapi-games--game-" data-method="GET" data-path="api/games/{game}" data-authed="0" data-hasfiles="0" data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}' onsubmit="event.preventDefault(); executeTryOut('GETapi-games--game-', this);">
<h3>
    Request&nbsp;&nbsp;&nbsp;
        <button type="button" style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-tryout-GETapi-games--game-" onclick="tryItOut('GETapi-games--game-');">Try it out ⚡</button>
    <button type="button" style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-canceltryout-GETapi-games--game-" onclick="cancelTryOut('GETapi-games--game-');" hidden>Cancel</button>&nbsp;&nbsp;
    <button type="submit" style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-executetryout-GETapi-games--game-" hidden>Send Request 💥</button>
    </h3>
<p>
<small class="badge badge-green">GET</small>
...
<h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
<p>
<b><code>game</code></b>&nbsp;&nbsp;<small>string</small>  &nbsp;
<input type="text" name="game" data-endpoint="GETapi-games--game-" data-component="url" required  hidden>
<br>
</p>
</form>
...
```bash
curl -X PUT \
    "http://localhost/api/games/natus" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
<div id="execution-results-PUTapi-games--game-" hidden>
    <blockquote>Received response<span id="execution-response-status-PUTapi-games--game-"></span>:</blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-games--game-"></code></pre>
</div>
<div id="execution-error-PUTapi-games--game-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-games--game-"></code></pre>
</div>
<form id="form-PUTapi-games--game-" data-method="PUT" data-path="api/games/{game}" data-authed="0" data-hasfiles="0" data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}' onsubmit="event.preventDefault(); executeTryOut('PUTapi-games--game-', this);">
<h3>
    Request&nbsp;&nbsp;&nbsp;
        <button type="button" style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-tryout-PUTapi-games--game-" onclick="tryItOut('PUTapi-games--game-');">Try it out ⚡</button>
    <button type="button" style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-canceltryout-PUTapi-games--game-" onclick="cancelTryOut('PUTapi-games--game-');" hidden>Cancel</button>&nbsp;&nbsp;
    <button type="submit" style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-executetryout-PUTapi-games--game-" hidden>Send Request 💥</button>
    </h3>
<p>
<small class="badge badge-darkblue">PUT</small>
 <b><code>api/games/{game}</code></b>
...
<p>
<b><code>game</code></b>&nbsp;&nbsp;<small>string</small>  &nbsp;
<input type="text" name="game" data-endpoint="PUTapi-games--game-" data-component="url" required  hidden>
<br>
</p>
</form>
...
<div id="execution-results-DELETEapi-games--game-" hidden>
    <blockquote>Received response<span id="execution-response-status-DELETEapi-games--game-"></span>:</blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-games--game-"></code></pre>
</div>
<div id="execution-error-DELETEapi-games--game-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-games--game-"></code></pre>
</div>
<form id="form-DELETEapi-games--game-" data-method="DELETE" data-path="api/games/{game}" data-authed="0" data-hasfiles="0" data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}' onsubmit="event.preventDefault(); executeTryOut('DELETEapi-games--game-', this);">
<h3>
    Request&nbsp;&nbsp;&nbsp;
        <button type="button" style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-tryout-DELETEapi-games--game-" onclick="tryItOut('DELETEapi-games--game-');">Try it out ⚡</button>
    <button type="button" style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-canceltryout-DELETEapi-games--game-" onclick="cancelTryOut('DELETEapi-games--game-');" hidden>Cancel</button>&nbsp;&nbsp;
    <button type="submit" style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-executetryout-DELETEapi-games--game-" hidden>Send Request 💥</button>
    </h3>
<p>
<small class="badge badge-red">DELETE</small>
 <b><code>api/games/{game}</code></b>
...
<p>
<b><code>game</code></b>&nbsp;&nbsp;<small>string</small>  &nbsp;
<input type="text" name="game" data-endpoint="DELETEapi-games--game-" data-component="url" required  hidden>
<br>
</p>
</form>
